      ...
      <div className="bg-[#141417] border border-[#2a2a32] rounded-2xl p-10 w-full max-w-lg">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setHasProducer(!hasProducer)}>
            <div className={`w-9 h-5 rounded-full relative transition-colors ${hasProducer ? 'bg-[#a78bfa]' : 'bg-[#2a2a32]'}`}>
          ...
          {hasProducer && (
            <input
              ...
              className="w-full bg-[#1c1c21] border border-[#2a2a32] rounded-lg text-white px-4 py-3 mt-3 text-sm outline-none focus:border-[#a78bfa]"
